...
/**
 * General settings of the application. Static because those general settings
...
public class Settings {
     ...
     */
    public static void setYouRobotSetting(int width, int height, int size, int effectArea, int detectionArea, int gridSizeX, int gridSizeY) {
